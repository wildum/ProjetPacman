...
public class Jeu {
	...
	public static void main(String[] args) {
		...
		Pacman Pac1 = new Pacman(84, 80, 2.5, 0.5 , "y"); //(pos_x, pos_y, largeur, vitesse, couleur)
		Pacman Pac2 = new Pacman(60,60, 2.5, 0.5, "g");
		Joueur J1 = new Joueur(Pac1); 
		Joueur J2 = new Joueur(Pac2);
		Fantome FantomeRose = new Fantome(56, 56, 2.5, 0.5 , "p");
		Fantome FantomeBleu = new Fantome(52, 52, 2.5, 0.5, "b");
		Fantome FantomeRouge = new Fantome(48, 48, 2.5, 0.5, "r");
		Fantome FantomeOrange = new Fantome(44, 44, 2.5, 0.5, "o");
